    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('univercity_id', models.IntegerField(blank=True, default=12, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payment', models.ImageField(upload_to='objection/payment')),
                ('is_processed', models.BooleanField(default=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('department', models.CharField(blank=True, choices=[('برمجيات', 'برمجيات'), ('شبكات', 'شبكات')], max_length=20, null=True)),
                ('subject', models.CharField(max_length=40)),
                ('image_id', models.ImageField(upload_to='re_practical/ID')),
                ('is_processed', models.BooleanField(default=False)),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        ...
        migrations.CreateModel(
            name='RequestDegreeGraduation',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('payment', models.ImageField(upload_to='request_degree/payemnt')),
                ('image_id_front', models.ImageField(blank=True, null=True, upload_to='request_degree_graduation/image_id_front')),
                ('image_id_back', models.ImageField(blank=True, null=True, upload_to='request_degree_graduation/image_id_back')),
                ('passport', models.ImageField(blank=True, null=True, upload_to='request_degree_graduation/passport')),
                ('request_degree', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='client.requestdegree')),
            ],
        ),
        migrations.CreateModel(
            name='RequestDegreeTransitional',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('year', models.CharField(choices=[('السنة الأولى', 'السنة الأولى'), ('السنة الثانية', 'السنة الثانية'), ('السنة الثالثة', 'السنة الثالثة'), ('السنة الرابعة', 'السنة الرابعة'), ('السنة الخامسة', 'السنة الخامسة')], max_length=20)),
                ('department', models.CharField(blank=True, choices=[('برمجيات', 'برمجيات'), ('شبكات', 'شبكات')], max_length=20, null=True)),
